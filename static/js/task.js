...
var Familiarization = function() {
	...
	var wordOrder =[1,3,5,7,9,11,13,15,17,0,2,4,6,8,10,12,14,16];
	var objOrder = [0,2,4,6,8,10,12,14,16,1,3,5,7,9,11,13,15,17];
	...
	var go_on  = function() {
		...
		var hiawordOrder =  [1,14,5,10,9,6,13,15,17,0,2,4,11,8,7,12,3,16]; // Remapped 6 
		//					[1,3,5,7,9,11,13,15,17,0,2,4,6,8,10,12,14,16];
		...
		var true_lexicon = studystim.slice();
		var blocks = [2,3];
